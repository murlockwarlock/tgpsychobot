...
const apps = [
  {
    ...
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_AUTOBUSBUSBOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_AUTOBUSBUSBOT_DATABASE_URL || process.env.DATABASE_URL || "",
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_ALENA322BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_ALENA322BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8082,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU01_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU01_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8083,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU02_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU02_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8084,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_VERAVEDA777_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "979514796,272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_VERAVEDA777_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8085,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONELIKEYOUAI03_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONELIKEYOUAI03_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8086,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONELIKEYOUAI04_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONELIKEYOUAI04_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8087,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_PSY5D_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_PSY5D_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8088,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONELIKEYOUAI_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONELIKEYOUAI_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8089,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONELIKEYOUAI02_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONELIKEYOUAI02_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8090,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU03_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU03_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8091,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONELIKEYOUAI05_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONELIKEYOUAI05_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8092,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU05_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU05_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8093,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU06_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU06_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8094,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_SOMEONEWITHYOU04_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "272982544,979514796,806750628",
      "DATABASE_URL": process.env.TELEGRAM_SOMEONEWITHYOU04_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8095,
  ...
  },
  {
    ...
    interpreter: "/root/telegram_bots/venv/bin/python",
    env: {
      "BOT_TOKEN": process.env.TELEGRAM_YOURSELF_WAY_BOT_TOKEN || process.env.BOT_TOKEN || "",
      "OWNER_IDS": "979514796,272982544,806750628,1372041348,100263465646,100005511792,100178646155",
      "DATABASE_URL": process.env.TELEGRAM_YOURSELF_WAY_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "SERVER_IP": "77.91.112.200",
      "APP_PORT": 8098,
  ...
  },
  {
    ...
    env: {
      "MAX_BOT_TOKEN": process.env.MAX_SE13639182_BOT_TOKEN || process.env.MAX_BOT_TOKEN || "",
      "DATABASE_URL": process.env.MAX_SE13639182_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
  ...
  },
  {
    ...
    cwd: "/root/telegram_bots/newbots",
    env: {
      "MAX_BOT_TOKEN": process.env.MAX_ID519010411655_BOT_TOKEN || process.env.MAX_BOT_TOKEN || "",
      "DATABASE_URL": process.env.MAX_ID519010411655_BOT_DATABASE_URL || process.env.DATABASE_URL || "",
      "OWNER_IDS": "100263465646,100005511792,100178646155",
      "MAX_USE_POLLING": "1",
